    ...
    def __init__(self):
        ...
        self.cur.execute("""CREATE TABLE IF NOT EXISTS {}
                    (id INTEGER PRIMARY KEY, message TEXT, user_login TEXT, full_name TEXT, created_time TEXT,
                     url TEXT, user_avatar_name TEXT, state TEXT)""".format(self.name_table))
        self.conn.commit()

    def save(self, message, user_login, full_name, created_time, url, user_avatar_name, state):
        self.cur.execute("INSERT INTO {}(message, user_login, full_name, created_time, url, user_avatar_name, state)"
                         " VALUES ({}, {}, {}, {}, {}, {}, {})"
